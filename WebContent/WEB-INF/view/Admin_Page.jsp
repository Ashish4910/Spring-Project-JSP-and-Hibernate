		...
		<div class="row ">
			...
			<table class="table table-striped ">
				...
				<c:forEach var="tempCustomer" items="${user}">
					...
					<c:url var="deleteLink" value="/DeleteAdmin">
						<c:param name="id" value="${tempCustomer.id}"></c:param>

						<c:url var="editUser" value="/AdminEdit">
					...
					<tr>
						...
						<%-- <td class="text-center"><img src="${tempCustomer.image}"></td> --%>

						<td class="text-center"><img
							src="data:image/jpeg;base64,${tempCustomer.imageBase64}"
							alt="User Image" style="width: 70px; margin-top: 15px;"></td>
